...
if($state)
{
$SQL = "SELECT m.Mechname as name,m.phoneno as phone,l.city as city,l.state as state,v.type as type FROM mechanic m,location l,vehicle v WHERE m.locid=l.id and m.vehicletype=v.id and l.city='$city' and l.state='$state'";
