...
$SQL = "SELECT mechname FROM mechanic WHERE mechname = '$name'";
...
if ($check == 0&&$name) {
    ...
    if($check1==0)
    {
        ...
        $row = mysqli_fetch_array($exeSQL);
        $vid=$row['id'];
        $SQL = "INSERT INTO mechanic (mechname,locid,vehicletype,phoneno,password) VALUES('$name','$locid','$vid','$no','$pass')";
